...
from vnpy.trader.setting import PROXY_HOST, PROXY_PORT,hyperliquid_account_tradfi
...
# 运行策略列表
STRATEGIES = [
    "HyperliquidTradfiExitTrend",
]
# gateway_name和登录账户映射
# hyperliquid主账户交易tradfi
LOG_ACCOUNT = {"HYPERLIQUID": hyperliquid_account_tradfi}
# ---------------------------------------------------------------------------
